...
As bibliotecas utilizadas no ambiente do Colab estão listadas no arquivo: **[requirements_local.txt](https://github.com/arthurvale/TCC-2026/blob/main/requirements_local.txt)**.
